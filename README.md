...
> Open source under the **GNU Lesser General Public License v3 (LGPL-3.0)** — see
...
unchanged. See the shipped `SupabaseSaveStorageProvider` and
`GoogleDriveSaveStorageProvider` under `src/` as complete reference implementations.

## License & support

The SaveHub API libraries and CLI are licensed under the **GNU Lesser General
Public License v3 (LGPL-3.0-or-later)** — see [LICENSE](LICENSE). You can reference
